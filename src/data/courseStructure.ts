...
export const courseStructure: Section[] = [
  ...
  {
    id: "section-2",
    title: "Análisis del mercado laboral y oportunidades",
    description: "Comprende el mercado laboral actual y encuentra las mejores oportunidades para tu perfil",
    order: 2,
    modules: [
      {
        id: "module-2-1",
      ...
      },
      {
        ...
        description: "Aprende a encontrar las mejores ofertas laborales",
        duration: "20 min",
        order: 2,
      },
      {
        id: "module-2-3",
        title: "Sectores e industrias en crecimiento",
        description: "Conoce los sectores con mayor demanda",
        duration: "15 min",
        order: 3,
      },
    ],
